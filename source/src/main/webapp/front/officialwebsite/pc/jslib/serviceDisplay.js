...
function loadServiceImgData(){
	...
	//清空信息
	service_ul.html("");
	zkAjaxData(NAMESPACE_OW_FRONT+"/serviceFrontAction!getService.action?order=desc&sort=releaseTime",conditionJSON,function(data,success){
		if(success&&data.success){
			/*<li class="service_li">
