...
<div id="serviceDetail">
	...
	<div id="serviceDetail_left">
		...
		<div id="serviceDetail_position">
			<span>◄</span>
			<span id="up"><a href="javascript:toView('view_serviceDisplay','right','view_serviceDisplay','')"><s:text name="front.ow.pc.view_serviceDisplay"/></a></span>
			>
			<span id="now"><s:text name="front.ow.pc.serviceDetail"/> </span>
		</div>
		<!-- 位置导航 end -->
