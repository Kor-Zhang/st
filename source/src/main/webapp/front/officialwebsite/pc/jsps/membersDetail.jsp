...
<div id="membersDetail">
	...
	<div id="membersDetail_left">
		...
		<div id="membersDetail_position">
			<span>◄</span>
			<span id="up"><a href="javascript:toView('view_membersDisplay','right','view_membersDisplay','')"><s:text name="front.ow.pc.view_membersDisplay"/></a></span>
			>
			<span id="now"><s:text name="front.ow.pc.membersDetail"/> </span>
		</div>
		<!-- 位置导航 end -->
		...
		<div id="membersDetail_changePage">
			<span id="prePage">
				...
				<<a href="javascript:void(0);"><s:text name="front.ow.pc.prePage"/></a>
			</span>
			<span id="nextPage">
			
				<a href="javascript:void(0);"><s:text name="front.ow.pc.nextPage"/></a>>
			</span>
	...
	<div id="membersDetail_right">
		<!-- 图片展示start -->
		<img id="membersDisplayImg" src="<c:url value='/membersFrontAction!getMembersById.action!head=default.png'/>" />
		<!-- 图片展示end -->
	</div>
	<!-- 右部div end -->
</div>
