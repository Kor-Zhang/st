...
<!-- 左边start -->
	<div id="serviceDisplay_left">
		...
		<div id="serviceDisplay_positionNav">
			<span>◄</span>
			<span id="up"><a href="javascript:toView('view_aboutUs','right','view_aboutUs',loadAboutUsDisplayView({}));"><s:text name="front.ow.pc.view_aboutUs"/></a></span>
			>
			<span id="now"><s:text name="front.ow.pc.service"/> </span>
		</div>
		<!-- 内容 start  -->
		<div id="service_content">
			<div id="serviceDetail_title">
				<s:text name="front.ow.pc.serviceDisplay"/>
			</div>
			
			<div id="serviceDetail_text">
				<s:text name="front.ow.pc.serviceIntroduction"/>
			</div>
			<!-- 筛选条件start -->
