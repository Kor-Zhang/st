...
<div id="newsDetail">
	...
	<div id="newsDetail_left">
		...
		<div id="newsDetail_position">
			<span>◄</span>
			<span id="up"><a href="javascript:toView('view_newsDisplay','right','view_newsDisplay','loadNewsDisplayView()')"><s:text name="front.ow.pc.view_newsDisplay"/></a></span>
			>
			<span id="now"><s:text name="front.ow.pc.newsDetail"/> </span>
		</div>
		<!-- 位置导航 end -->
